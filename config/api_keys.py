...
ALCHEMY_SOLANA_GRPC = "solana-mainnet.g.alchemy.com"  # Yellowstone gRPC endpoint (X-Token auth)
ALCHEMY_BASE_RPC = f"https://base-mainnet.g.alchemy.com/v2/{ALCHEMY_API_KEY}" if ALCHEMY_API_KEY and ALCHEMY_API_KEY != "YourApiKeyToken" else None
ALCHEMY_ARBITRUM_RPC = f"https://arb-mainnet.g.alchemy.com/v2/{ALCHEMY_API_KEY}" if ALCHEMY_API_KEY and ALCHEMY_API_KEY != "YourApiKeyToken" else None
